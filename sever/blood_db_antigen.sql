...
CREATE TABLE `antigen` (
  `antigen_type` varchar(45) NOT NULL,
  `antigen_name` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`antigen_type`)
...
INSERT INTO `antigen` VALUES ('+','Rhesus Factor'),('A','A-antigen'),('B','B-antigen');
